...
class Solution {
  ...
  int main() {
    ...
    printVec(twoSum(a, 9));   // Expected: [0,1]
    printVec(twoSum(b, 6));   // Expected: [1,2]
    printVec(twoSum(c, 6));   // Expected: [0,1]
    return 0;
  }`,
    },
    expectedOutput: {
...
class Solution {
  ...
  void printChars(const vector<char>& v) {
    cout << "[";
    for (size_t i = 0; i < v.size(); i++) {
      if (i) cout << ",";
      cout << "\"" << v[i] << "\"";
  ...
  int main() {
    ...
    reverseString(test1);
    printChars(test1);  // Expected: ["o","l","l","e","h"]

    vector<char> test2 = {'H','a','n','n','a','h'};
    reverseString(test2);
    printChars(test2);  // Expected: ["h","a","n","n","a","H"]
    return 0;
  }`,
    },
    expectedOutput: {
